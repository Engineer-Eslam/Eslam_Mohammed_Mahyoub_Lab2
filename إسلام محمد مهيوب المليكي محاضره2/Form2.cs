...
namespace إسلام_محمد_مهيوب_المليكي_محاضره2
{
    public partial class Form2 : Form
    {
        ...
        {
            if (textBox2.Text.Trim() == "0" || textBox2.Text.Trim() == "-0")
            {
                MessageBox.Show("لا يمكن القسمه على صفر "," تحذير ",MessageBoxButtons.YesNoCancel,MessageBoxIcon.Warning);
                textBox2.Text = "";
                textBox2.Focus();
            }
            else
        ...
        //{
        //    button1.Enabled = button2.Enabled = button3.Enabled = button4.Enabled = (textBox1.Text.Trim() != "") && (textBox2.Text.Trim() != "");
        //}
